...
function Parallax({ startScroll, endScroll, speed, opacity, transform, offset, background, gradient, filter, disabled, children }) {
    ...
    // --- J S X   R E T U R N--- //
    return (React__default["default"].createElement("div", { style: { position: "relative", width: "100%", height: "fit-content" } },
        React__default["default"].createElement("div", { ref: ref, style: {
                position: "relative",
                width: "100%",
                height: "fit-content",
