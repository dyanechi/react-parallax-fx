...
interface IParallaxProps {
    ...
    extend?: boolean;
    ease?: number;
    easeFn?: 'linear' | 'parabolic' | undefined;
 ...
 */
declare const useParallax: ({ startScroll, endScroll, fadeIn, fadeOut, keyframes, offset, disabled, extend, ease, easeFn, onTransitionChange, }: IParallaxProps) => {
